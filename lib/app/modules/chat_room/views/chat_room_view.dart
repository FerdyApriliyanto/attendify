                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.active) {
                    ...
                    return StreamBuilder<DocumentSnapshot<Object?>>(
                        stream: controller.receiverChatRoomStream((Get.arguments
                                  ...
                                  if (index == 0) {
                                    return Column(
                                      children: [
                                        ...
                                        ChatBubbleWidget(
                                          isSender: chatsDoc[index]['sender'] ==
                                                  authController
                                    ...
                                    if (chatsDoc[index]['groupTime'] ==
                                      ...
                                      return Column(
                                        children: [
                                          ...
                                          Text(
                                              '${chatsDoc[index]['groupTime']}'),
                                          ChatBubbleWidget(
                                            isSender: chatsDoc[index]
                                                        ['sender'] ==
                                                    authController
                                                        .currentLoggedInUserModel
                                                        .value
                  ...
                  decoration: InputDecoration(
                      prefixIcon: IconButton(
                        ...
                        icon: Obx(() => Icon(
                              ...
                              color: controller.isEmojiShown.isTrue
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            onTap: () => controller.sendChat(
                                authController
                                    .currentLoggedInUserModel.value.email!,
