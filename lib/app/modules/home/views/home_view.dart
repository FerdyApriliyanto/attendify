                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return StreamBuilder<
                            ...
                            stream:
                                controller.friendsStream(data['connection']),
                            builder: (context, listTileSnapshot) {
                              if (listTileSnapshot.connectionState ==
                                  ConnectionState.active) {
                                var dataListTile =
                                    listTileSnapshot.data!.data();

                                return ListTile(
                                  onTap: () => controller.openChatRoom(
                                      '${data.id}',
                                      authController.currentLoggedInUserModel
                                          .value.email!,
                                      '${data['connection']}'),
